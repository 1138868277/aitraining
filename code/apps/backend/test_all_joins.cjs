...
(async () => {
  try {
    const codes = [
      '5313G11110B10020005003001197003',
      '5313G11110B10020007003000997003',
      '5313G11110B10020046003000797003'
    ];
    ...
    console.log('Executing full detail query...');
    console.time('full_detail');
    const r = await pool.query(sql, codes);
    console.log('Rows:', r.rows.length);
    if (r.rows.length > 0) console.log('First row:', JSON.stringify(r.rows[0]));
    console.timeEnd('full_detail');
